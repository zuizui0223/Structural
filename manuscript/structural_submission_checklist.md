...
- [x] GitHub Actions expiry risk mitigated: verified A-Islands raw artifact copied to a private outside-Actions backup and re-downloaded with exact SHA-256 match.
- [ ] Include and reverify the same authoritative raw artifact in the final DOI/public release archive.
