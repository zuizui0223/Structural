...
def main():
    ...
    if census.get("schema")!="structural.landfrag_relative_topology_metadata.v0_1":
    ...
    protocol={
        "schema":"structural.landfrag_relative_topology_protocol.v0_1",
        "status":"FROZEN_BEFORE_MONOLITHIC_ABUNDANCE_ACCESS",
