...
def main():
    ...
    protocol={
        "schema":"structural.gift_community_topology_protocol.v0_3",
        "status":"QUALIFIED_TO_OPEN_COMMUNITY_RESPONSE" if qualified else "STOP_PRE_RESPONSE_NON_ESTIMABLE",
        "study_family":"fresh community-level island-biogeography study; v0.3 preserves H1/H3 from v0.2 and replaces only the pre-response non-estimable GMMC H2 moderator with external geological origin",
        "gift_version":"3.2",
        "clades":list(CLADES),
        ...
        "H2_primary":{
            ...
            "analysis_population":"archipelagos with >=80% exact GIFT entity_ID coverage in Roeble et al. Supplementary Data 3",
        ...
        "pre_response_predecessor":{
            ...
            "response_values_accessed_in_v0_1_or_v0_2":False,
        },
        ...
        "forbidden_after_response":[
            ...
            "change Roeble entity_ID geology matching or 80% coverage rule",
